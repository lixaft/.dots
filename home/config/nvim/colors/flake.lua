...
-- Markdown.
hl("RenderMarkdownBullet", { fg = c.syntax.operator })
hl("RenderMarkdownLink", { fg = c.lavender })
hl("RenderMarkdownTableHead", { fg = c.ui.separator })
hl("RenderMarkdownTableRow", { fg = c.ui.separator })
hl("RenderMarkdownTableFill", { fg = c.ui.separator })
hl("RenderMarkdownChecked", { fg = c.green })
hl("RenderMarkdownCode", { bg = c.bg2 })
hl("RenderMarkdownDash", { fg = c.ui.separator })
hl("RenderMarkdownH1", { fg = c.purple })
hl("RenderMarkdownH1Bg", { fg = c.purple, bg = c.ui.dim })
hl("RenderMarkdownH2", { fg = c.lavender })
hl("RenderMarkdownH2Bg", { fg = c.lavender, bg = c.ui.dim })
hl("RenderMarkdownH3", { fg = c.lavender2 })
hl("RenderMarkdownH3Bg", { fg = c.lavender2, bg = c.ui.dim })
hl("RenderMarkdownH4", { fg = c.gray })
hl("RenderMarkdownH4Bg", { fg = c.gray, bg = c.ui.dim })
hl("RenderMarkdownH5", { fg = c.syntax.comment })
hl("RenderMarkdownH5Bg", { fg = c.syntax.comment, bg = c.ui.dim })
hl("RenderMarkdownH6", { fg = c.black })
hl("RenderMarkdownH6Bg", { fg = c.black, bg = c.ui.dim })
hl("RenderMarkdownUnchecked", { fg = c.syntax.operator })
